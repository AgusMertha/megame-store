    ...
    <section className="complete-checkout mx-auto pt-lg-145 pb-lg-145 pt-100 pb-80">
      <div className="container-fluid">
        <div className="text-center">
          <Image className="img-fluid" src="/img/complete-checkout-1.png" width={343} height={300}/>
        </div>
        ...
        <div className="button-group d-flex flex-column mx-auto">
          ...
          <Link href="#">
            <a className="btn btn-whatsapp fw-medium text-lg color-palette-1 rounded-pill" role="button">WhatsApp ke Admin</a>
          </Link>
        </div>
      </div>
    </section>
