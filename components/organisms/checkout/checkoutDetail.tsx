     ...
     <div className="purchase pt-md-50 pt-30">
        ...
        <p className="text-lg color-palette-1 mb-20">Price 
          <span className="purchase-details">
            <NumberFormat value={itemPrice} displayType={'text'} prefix={'Rp. '} thousandSeparator={'.'} decimalSeparator={","}/>
          </span>
        </p>
        <p className="text-lg color-palette-1 mb-20">Tax (10%) 
          <span className="purchase-details">
            <NumberFormat value={tax} displayType={'text'} prefix={'Rp. '} thousandSeparator={'.'} decimalSeparator={","}/>
          </span>
        </p>
        <p className="text-lg color-palette-1 mb-20">Total 
          <span className="purchase-details color-palette-4">
            <NumberFormat value={totalPrice} displayType={'text'} prefix={'Rp. '} thousandSeparator={'.'} decimalSeparator={","}/>
          </span>
          </p>
      </div>
